...
rem Full send:
rem pyside6-deploy -c w32.pysidedeploy.spec
python -m nuitka ^
    --standalone ^
    ...
    --noinclude-dlls=qt6quick3dparticle*.dll ^
    --noinclude-dlls=qt6quick3dxr.dll ^
    --noinclude-dlls=*texttospeech*.dll ^
    --noinclude-dlls=qt6virualkeyboard*.dll ^
    ...
    --noinclude-dlls=qt6sensor*.dll ^
    --noinclude-dlls=*spacialaudio*.dll ^
    --noinclude-dlls=qt6sql.dll ^
    --noinclude-dlls=*statemachine*.dll ^
    --noinclude-dlls=*test*.dll ^
    --noinclude-dlls=qt63danimation.dll ^
    --noinclude-dlls=qt63dcore.dll ^
    --noinclude-dlls=qt63dextras.dll ^
    --noinclude-dlls=qt63dinput.dll ^
    --noinclude-dlls=qt63dlogic.dll ^
    --noinclude-dlls=qt63drender.dll ^
    --noinclude-dlls=qt6labs*.dll ^
    --noinclude-dlls=qt6quickdialogs*.dll ^
    --noinclude-dlls=qt6charts*.dll ^
    --noinclude-dlls=qt6graphs*.dll ^
    --noinclude-dlls=qt6positioningquick.dll ^
    --noinclude-dlls=qt6positioningquick.dll ^
