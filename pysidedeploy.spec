...
# application icon
icon = C:\Users\User\Documents\dev\minecraftlauncher-py\.venv\Lib\site-packages\PySide6\scripts\deploy_lib\pyside_icon.ico
...
modules = Core,Gui,Network,OpenGL,Qml,QmlMeta,QmlModels,QmlWorkerScript,Quick,Quick3D,Quick3DRuntimeRender,Quick3DUtils,QuickControls2,QuickTemplates2,QuickWidgets,ShaderTools,Svg,SvgWidgets,Widgets

# qt plugins used by the application. only relevant for desktop deployment
# for qt plugins used in android application see [android][plugins]
plugins = accessiblebridge,assetimporters,egldeviceintegrations,generic,iconengines,imageformats,networkaccess,networkinformation,platforminputcontexts,platforms,platforms/darwin,platformthemes,qmllint,qmltooling,scenegraph,styles,tls,vectorimageformats,wayland-decoration-client,wayland-graphics-integration-client,wayland-shell-integration,xcbglintegrations
