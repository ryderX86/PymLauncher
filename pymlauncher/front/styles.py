...
from pymlauncher.front.rgb import hex_to_rgbi
...
def gen_palette():
    ...
    palette.setColor(
        CGroup.Disabled, CRole.WindowText, hex_to_qrgb(TEXT_MUTED)
    )
    palette.setColor(CRole.ButtonText, hex_to_qrgb(TEXT_PRIMARY))
    palette.setColor(
        CGroup.Disabled, CRole.ButtonText, hex_to_qrgb(TEXT_MUTED)
    )
